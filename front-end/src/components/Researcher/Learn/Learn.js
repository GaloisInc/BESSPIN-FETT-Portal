...
export default function Learn() {
  return (
    <div className="h-full pt-6 pb-12 pl-12 pr-12">
      ...
      <div className="pt-6">
        <h2 className="text-lg font-normal text-gray-200">Quickstart </h2>
        ...
        <p className="pt-2 text-sm leading-tight text-gray-200">
          NOTE: You will be limited to a maximum of two (2) active instances at any given time, though instances can be
          paused and restarted from this interface.
        </p>
      </div>

      <div className="pt-6">
        <h2 className="text-lg font-normal text-gray-200">SSITH Processors</h2>
        <p className="pt-2 text-sm leading-tight text-gray-200">
          Cambridge/SRI
          <ul className="pl-4 list-disc list-inside">
            <li>
              ...
              <ul className="pl-6 list-disc list-inside">
                ...
                <li>
                  Security researchers are given access to an unprivileged shell to interact with custom applications
                </li>
              </ul>
            </li>
      ...
      <div className="pt-6">
        <h2 className="text-lg font-normal text-gray-200">Technical descriptions of SSITH security technologies</h2>
        <p className="pt-2 text-sm leading-tight text-gray-200">
      ...
      <div className="pt-6">
        <h2 className="text-lg font-normal text-gray-200">FETT-Voting</h2>
        <p className="pt-2 text-sm leading-tight text-gray-200">
          Application Description: This application represents the minimum demonstrable implementation of a Voter
          Registration application, intended to run on SSITH hardware. An actual production Voter Registration system
          would have a significantly larger footprint; among other implementation choices, it would be implemented with
          a more full-featured DBMS than SQLite. The application enables users to submit registration information and to
          upload image files intended to contain proof of identity and right to vote. It also enables election officials
          to promote pending voter registrations to active voter registrations, and to modify the voter registration
          database in various ways.
        </p>

        <p className="pt-2 text-sm leading-tight text-gray-200">
          In keeping with the real-world threats against voter registration systems, the primary threats we consider in
          scope for FETT are unauthorized disclosure of voter registration information, and unauthorized modification or
          deletion of voter registration information. In particular, because voter registrations are typically public
          information, unauthorized disclosure is defined as one of the following that occurs while not properly
          authenticated to the system as an election official::
          <ul className="pl-4 list-disc list-inside">
            <li>Disclosure of the proof of identity used by any voter at registration time</li>
            <li>
              Disclosure of any part of a voter registration record that is marked “confidential”, including the fact of
              its existence
            </li>
          </ul>
          Unauthorized modification or deletion includes any change to voter registration records that occurs while not
          properly authenticated to the system as an election official, except that a voter whose record is not marked
          “confidential” can modify their own record (after which it becomes a pending registration) by authenticating
          to the system with their existing registration information (including the original proof of identity they
          submitted).
        </p>
        ...
        <p className="pt-2 text-sm leading-tight text-gray-200">
          ...
          unrestricted access have significant overhead that is not reasonable for either the FPGA-based implementation
          platform or for the FETT competition.
        </p>
      </div>
    </div>
  );
